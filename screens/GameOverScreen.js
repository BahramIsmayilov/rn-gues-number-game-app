...
import { View, Text, StyleSheet, Button, Image, ScrollView, KeyboardAvoidingView } from 'react-native';
				...
				<View style={styles.screen}>
					...
					<View style={styles.resultContainer}>
						<Text style={{ ...styles.resultText, ...DefaultStyle.titleSmall }}>
							Your phone needed <Text style={styles.resultNumber}>{props.roundsNumber}</Text> rounds to
							guess the number <Text style={styles.resultNumber}>{props.userNumber}.</Text>
						</Text>
					</View>
